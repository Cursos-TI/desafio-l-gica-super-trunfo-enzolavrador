...
switch (atributo2) {
        case 1: // População
            ...
            populacao1 > populacao2 ? printf("Jogador 1 ganhou!\n") : populacao1 < populacao2 ? printf("Jogador 2 ganhou!\n") : printf("Empate!\n");
            break;
        ...
        case 2: // Área
            ...
            area1 > area2 ? printf("Jogador 1 ganhou!\n") : area1 < area2 ? printf("Jogador 2 ganhou!\n") : printf("Empate!\n");
            break;
        ...
        case 3: // PIB
            ...
            pib1 > pib2 ? printf("Jogador 1 ganhou!\n") : pib1 < pib2 ? printf("Jogador 2 ganhou!\n") : printf("Empate!\n");
            break;
        ...
        case 4: // Pontos turísticos
            ...
            pontos1 > pontos2 ? printf("Jogador 1 ganhou!\n") : pontos1 < pontos2 ? printf("Jogador 2 ganhou!\n") : printf("Empate!\n");
            break;
        ...
        case 5: // Densidade populacional (quanto menor, melhor)
            ...
            densidade1 < densidade2 ? printf("Jogador 1 ganhou!\n") : densidade1 > densidade2 ? printf("Jogador 2 ganhou!\n") : printf("Empate!\n");
            break;
        ...
        case 6: // PIB per Capita
            ...
            pibpercapita1 > pibpercapita2 ? printf("Jogador 1 ganhou!\n") : pibpercapita1 < pibpercapita2 ? printf("Jogador 2 ganhou!\n") : printf("Empate!\n");
            break;
        ...
        case 7: // Super poder
            ...
            superpoder1 > superpoder2 ? printf("Jogador 1 ganhou!\n") : superpoder1 < superpoder2 ? printf("Jogador 2 ganhou!\n") : printf("Empate!\n");
            break;
